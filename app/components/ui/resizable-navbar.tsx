    ...
    >
      {items.map((item, idx) => (
        <Link
          ...
          onClick={onItemClick}
          className="relative px-2 py-2 text-white hover:text-[#019D4D] focus:outline-none focus:ring-2 focus:ring-[#019D4D] rounded-md sm:px-3"
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
...
export const NavbarLogo: React.FC = () => {
  return (
    ...
    >
      ...
      />
      <span className="font-medium">BGSolar</span>
    </Link>
  );
};
